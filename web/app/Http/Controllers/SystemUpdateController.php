...
class SystemUpdateController extends Controller {
    ...
    public function index() {
        ...
        $system_version = Setting::where('name', 'system_version')->value('value');
    ...
    public function update(Request $request) {
        ...
        try {
            ...
            $current_version = Setting::where('name', 'system_version')->value('value');
          
            $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL            => 'https://validator.wrteam.in/prime_web_validator?purchase_code=' . $request->purchase_code . '&domain_url=' . $app_url,
