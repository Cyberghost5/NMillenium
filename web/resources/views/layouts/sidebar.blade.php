    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-block">
                <div class="logo text-center">
                    <a href="#">
                        <img src="{{ empty($admin_logo) ? url('assets/images/logo/sidebarlogo2.png') : $admin_logo }}" alt="Logo">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub always-open">
                    <a href="#" class='sidebar-link'>
                        ...
                        <span class="menu-item">{{ __('onboarding') }}</span>
                    </a>
                    <ul class="submenu active" style="padding-left: 0rem">
